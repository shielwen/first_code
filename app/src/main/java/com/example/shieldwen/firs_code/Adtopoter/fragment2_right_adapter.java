...
public class fragment2_right_adapter extends ArrayAdapter<fragment2_fenlei_s> {
    private int resourceId;

    public fragment2_right_adapter(Context context, int textViewResourId, List<fragment2_fenlei_s> objects){
    ...
    public View getView(int position, View converView, ViewGroup parent){
        ...
        TextView textview1 =(TextView)view.findViewById(R.id.fragment2_right1_button1);

        //动态的设置两个属性
        textview1.setText(fenlei.getName1());
        return view;
    }
